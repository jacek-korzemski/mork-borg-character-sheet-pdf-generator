        ...
        <Sidebar open={props.open}>
            ...
            <div className="box-list">
                ...
                {initialWeapons.map((elem, index) => (
                    <ButtonSelect key={index} selected={app.weapons.includes(elem)} onClick={() => toggleWeapons(elem)}>
                        {elem}
                    </ButtonSelect>
                ))}
            </div>
            ...
            <div className="box-list">
                ...
                {initialArmor.map((elem, index) => (
                    <ButtonSelect key={index} selected={app.armor.includes(elem)} onClick={() => toggleArmor(elem)}>
                        {elem}
                    </ButtonSelect>
                ))}
            </div>
            ...
            <div className="box-list">
                ...
                {initialEquipement.map((elem, index) => (
                    <ButtonSelect key={index} selected={app.equipement.includes(elem)} onClick={() => toggleEquipement(elem)}>
                        {elem}
                    </ButtonSelect>
                ))}
            </div>
